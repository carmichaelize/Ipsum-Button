;(function() {
    ...
    var Ipsum = function( ipsum_array ){

        this.content = ipsum_array;
        this.count;
    ...
    tinymce.create('tinymce.plugins.Ipsum', {
        init : function(ed, url) {
            ...
            //Create Ipsum instance
            var lorem = new Ipsum( ipsum_array );
            ...
            ed.addCommand('lorem', function() {
                return ed.execCommand( 'mceInsertContent', 0, lorem.get() );
            });
